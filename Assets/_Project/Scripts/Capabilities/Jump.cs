...
namespace DragonspiritGames.EchoesOfFire
{
    ...
    public class Jump : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            _collisionDataDetector = GetComponent<CollisionDataDetector>();
        ...
        void FixedUpdate()
        {
            _onGround = _collisionDataDetector.OnGround;
